          ...
          <AnimatePresence>
            {cart.map((pro) => (
              <motion.div
                ...
                key={pro.id}
                className="product d-flex border-bottom p-2"
              >
                ...
                <div className="ms-3 pro-info d-flex flex-column justify-content-evenly w-100">
                  ...
                  <div className="qty-option d-flex justify-content-between align-items-center">
                    <div className="options d-flex align-items-center btn-group">
                      <button
                        className={`btn border fw-bold rounded-pill rounded-end py-1 btn-secondary text-light ${
                      ...
                      <button
                        className="btn border fw-bold rounded-pill rounded-start py-1 btn-success text-light"
                        onClick={() => {
